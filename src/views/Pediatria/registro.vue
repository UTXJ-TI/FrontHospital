                ...
                <b-row>
                  ...
                  >
                    <Field
                      class="form-control mb-2"
                      type="text"
                      placeholder="Presion Arterial Sistolica"
                      name="Email"
                      :rules="isRequire"
                  ...
                  <b-form-group
                    class="col-md-6"
                    label="Presion Arterial Distolica:"
                    label-for="pno"
                  >
                    <Field
                      class="form-control mb-2"
                      ...
                      name="pincode"
                      id="pno"
                      placeholder="Presion Arterial Distolica"
                      :rules="isRequire"
