      ...
      <b-col sm="12">
        <iq-card>
          <template v-slot:headerTitle>
            <h4 class="card-title">
              Aprovecha decuentos para las sesiones quirúrgicas
            </h4>
          </template>
          <template v-slot:body>
                ...
                <ul class="iq-timeline">
                  <li>
                    ...
                    <div class="d-inline-block w-100">
                      <p>
                        "¡Las actividades recientes en la Programación
                        Quirúrgica han sido un éxito! ¡Gracias a todo el equipo
                        por su arduo trabajo y dedicación!"
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="d-inline-block w-100">
                      <p>
                        "¡Hoy fue un día lleno de logros en la sala de
                        operaciones! Gracias al equipo de Programación
                        Quirúrgica por su excelente desempeñ
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="d-inline-block w-100">
                      <p>
                        "Nuestro equipo de Programación Quirúrgica ha demostrado
                        una vez más su profesionalismo y eficiencia. ¡Estamos
                  ...
                  <li>
                    ...
                    <div class="d-inline-block w-100">
                      <p>
                        "¡El equipo de Programación Quirúrgica ha superado todas
                        las expectativas hoy! Su compromiso con la excelencia es
                  ...
                  <li>
                    ...
                    <div class="d-inline-block w-100">
                      <p>
                        "Los miembros del equipo de Programación Quirúrgica han
                        demostrado su capacidad para manejar incluso las
                        situaciones más desafiantes. ¡Gracias por su arduo
                        trabajo!"
                      </p>
                    </div>
                  </li>
